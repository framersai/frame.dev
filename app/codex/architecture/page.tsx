...
export const metadata: Metadata = {
  title: 'Frame Codex Architecture – Understanding Weaves, Looms & Strands',
  description: 'Visual guide to Frame Codex architecture: how Weaves, Looms, and Strands create a structured knowledge infrastructure for AI and superintelligence.',
}
    ...
    <PageLayout>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-black mb-6 bg-gradient-to-r from-purple-600 via-blue-600 to-green-600 bg-clip-text text-transparent">
            The Architecture of Knowledge
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Understanding how Weaves, Looms, and Strands create the foundation for humanity&apos;s knowledge repository
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Frame Codex uses a simple yet powerful three-tier hierarchy to organize all knowledge. 
...
---`}
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-800">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                <Link 
                  href="/codex?path=weaves/frame/looms/openstrand&file=weaves/frame/looms/openstrand/strands/architecture.md"
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-purple-600 to-blue-600 rounded-3xl p-12 text-white">
          ...
          <p className="text-lg mb-8 text-purple-100">
            Dive into Frame Codex and see this architecture in action
          </p>
...
const data = await fetch(
  'https://api.frame.dev/v1/strands/openstrand-architecture'
          ...
          <div className="grid gap-4 md:grid-cols-2 not-prose">
            <Link 
              href="https://github.com/framersai/codex/blob/main/docs/openstrand-architecture.md"
            ...
            <Link 
              href="https://github.com/framersai/codex/blob/main/docs/schema-reference.md"
              className="block p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-purple-500 dark:hover:border-purple-500 transition-colors"
            >
