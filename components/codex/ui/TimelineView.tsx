 ...
 */
export default function TimelineView({ history, onNavigate, onClose }: TimelineViewProps) {
  /**
              ...
              <div className="space-y-12">
                {groupedHistory.map((group, groupIndex) => (
                  ...
                  >
                    {/* Period label */}
                    <div
                      className={`absolute left-0 md:left-0 -translate-y-2 text-sm font-bold uppercase tracking-wider ${group.color}`}
                    >
                      {group.label}
                    </div>
                        ...
                        >
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-gray-500 dark:text-gray-400 truncate mb-2">{entry.path}</p>
