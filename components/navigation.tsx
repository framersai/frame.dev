      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/framersai" className="nav-link" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://npmjs.com/org/framers" className="nav-link" aria-label="NPM" target="_blank" rel="noopener noreferrer">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
