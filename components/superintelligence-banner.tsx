  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 text-center border border-gray-200 dark:border-gray-800">
        ...
        <div className="mb-3 inline-flex items-center gap-2 px-4 py-1.5 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 rounded-full text-sm font-medium">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8">
          ...
          to answer any question and perform any task. Powered by the Frame Codex and designed 
        ...
        <div className="flex flex-wrap gap-4 justify-center items-center">
          <Link 
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-medium hover:from-purple-700 hover:to-blue-700 transition-all transform hover:scale-105 shadow-lg"
          >
            Learn More
          ...
          <button 
            className="inline-flex items-center gap-2 px-6 py-3 border-2 border-purple-600 text-purple-600 dark:text-purple-400 rounded-lg font-medium hover:bg-purple-600 hover:text-white dark:hover:text-white transition-all"
