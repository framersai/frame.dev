...
import { Book, ExternalLink, Search, ChevronRight } from 'lucide-react'
...
export default function FrameCodexBanner() {
  ...
  return (
    <>
        ...
        >
          ...
          <div className="relative p-8 lg:p-12 flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                The codex of humanity — the best of humanity&apos;s knowledge stored on the web, 
                made accessible for LLMs to crawl and utilize as a supercomputer of information.
              </motion.p>
              ...
              >
                ...
                >
                  ...
                  <ExternalLink className="w-4 h-4 transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                </motion.a>
              </motion.div>
              ...
              >
                <p className="text-sm text-ink-600 dark:text-paper-400">
                  ...
                  {' '}                on top of the Frame Codex, enabling intelligent knowledge management and processing.
                </p>
              </motion.div>
              ...
              >
                <div className="p-3 bg-gradient-to-br from-paper-100/30 to-paper-200/30 dark:from-ink-800/30 dark:to-ink-700/30 rounded-lg backdrop-blur-sm border border-ink-200/10 dark:border-white/5">
                  <p className="text-xs font-semibold text-ink-900 dark:text-paper-100 mb-1">Strand Architecture</p>
                  <p className="text-xs text-ink-600 dark:text-paper-400">Recursive knowledge strands with typed edges</p>
                </div>
                <div className="p-3 bg-gradient-to-br from-paper-100/30 to-paper-200/30 dark:from-ink-800/30 dark:to-ink-700/30 rounded-lg backdrop-blur-sm border border-ink-200/10 dark:border-white/5">
                  <p className="text-xs font-semibold text-ink-900 dark:text-paper-100 mb-1">Intelligent Pipeline</p>
                  <p className="text-xs text-ink-600 dark:text-paper-400">20+ format imports with AI processing</p>
                </div>
                <div className="p-3 bg-gradient-to-br from-paper-100/30 to-paper-200/30 dark:from-ink-800/30 dark:to-ink-700/30 rounded-lg backdrop-blur-sm border border-ink-200/10 dark:border-white/5">
                  <p className="text-xs font-semibold text-ink-900 dark:text-paper-100 mb-1">Local-First</p>
                  <p className="text-xs text-ink-600 dark:text-paper-400">PGlite/PostgreSQL with full ownership</p>
                </div>
              </motion.div>
            </div>
      ...
      {/* Frame Codex Viewer Modal */}
      <AnimatePresence>
        {isCodexOpen && (
          <FrameCodexViewer isOpen={isCodexOpen} onClose={() => setIsCodexOpen(false)} />
        )}
      </AnimatePresence>
    </>
  )
